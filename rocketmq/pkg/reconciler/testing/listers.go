...
import (
	...
	messagingv1alpha1 "knative.dev/eventing-contrib/rocketmq/pkg/apis/messaging/v1alpha1"
	fakemessagingclientset "knative.dev/eventing-contrib/rocketmq/pkg/client/clientset/versioned/fake"
	messaginglisters "knative.dev/eventing-contrib/rocketmq/pkg/client/listers/messaging/v1alpha1"
)
...
func (l *Listers) GetRocketmqChannelLister() messaginglisters.RocketmqChannelLister {
	return messaginglisters.NewRocketmqChannelLister(l.indexerFor(&messagingv1alpha1.RocketmqChannel{}))
}
