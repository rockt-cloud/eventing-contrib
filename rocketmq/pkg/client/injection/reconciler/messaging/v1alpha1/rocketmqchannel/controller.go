...
import (
	...
	versionedscheme "knative.dev/eventing-contrib/tmp2/pkg/client/clientset/versioned/scheme"
	client "knative.dev/eventing-contrib/tmp2/pkg/client/injection/client"
...
const (
	defaultControllerAgentName = "rocketmqchannel-controller"
	defaultFinalizerName       = "rocketmqchannels.messaging.knative.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	lister := rocketmqchannelInformer.Lister()
